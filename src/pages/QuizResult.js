                ...
                return(
                    <div> 
                      <div>
                         ...
                         {item.nom ? <><p className='p-none'>Capital of {item.nom} is :</p> <p style={{marginLeft:'10px'}}> {item.capitale}</p></> : <><p className='p-none'> This is the flag of</p><p> {item.namePays}</p></>}
