...
function QuizComponent(props) { 
    ...
    function handleColor(e) {
        if (button1.current.className == 'hover-button-responses' || button2.current.className == 'hover-button-responses' || button3.current.className == 'hover-button-responses' || button4.current.className == 'hover-button-responses') {
            button1.current.className = 'button-bleu';
            button2.current.className = 'button-bleu';
            button3.current.className = 'button-bleu';
            button4.current.className = 'button-bleu';
        } 
        e.target.className = 'button-yellow';
        props.funcRight(e.target.textContent);
    }
